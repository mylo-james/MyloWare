 ...
 */
export function notifyTestResults(passed: number, failed: number, coverage?: number): NotificationResult {
 ...
 */
export function notifyDeployment(environment: string, version: string, success: boolean): NotificationResult {
