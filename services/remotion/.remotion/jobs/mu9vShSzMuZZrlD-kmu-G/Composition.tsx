...
const OBJECTS = [
  'Lava Puppy', 'Velvet Moss Puppy', 'Shimmering Cloud Puppy', 'Waterfall Puppy',
  'Golden Aura Puppy', 'Crystalline Puppy', 'Symmetrical Shadow Puppy', 'Mystic Smoke Puppy',
  'Cosmic Star Puppy', 'Stone Guardian Puppy', 'Electric Wave Puppy', 'Iridescent Dream Puppy'
];
