...
const objects = ["Flammable Puppy","Velvet Earth Puppy","Dual Cloud Puppies","Water Droplet Puppy","Golden Light Puppy","Crystalline Puppy","Symmetrical Flower Puppy","Shadowy Mist Puppy","Celestial Star Puppy","Stone and Moss Puppy","Electric Neon Puppy","Dreamy Watercolor Puppy"];
