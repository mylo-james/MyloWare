...
// Updated Object Names according to the creative direction
const OBJECTS = [
  'Flamed Puppy', 'Velvet Seed Puppy', 'Shifting Shadow Puppy', 'Watercolor Puppy',
  'Golden Sun Puppy', 'Crystal Clear Puppy', 'Harmonious Cloud Puppy', 'Liquid Shadow Puppy',
  'Cosmic Star Puppy', 'Stone-carved Puppy', 'Electric Plasma Puppy', 'Dreamy Mist Puppy'
];
