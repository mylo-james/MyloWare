  ...
  return (
    <AbsoluteFill>
      <Sequence durationInFrames={150}>  
        ...
        <AnimatedText text="Strength does not come from winning." animation="fade-up" />
      </Sequence>
      <Sequence from={150} durationInFrames={150}>
        <Transition type="crossfade" durationFrames={30}>
          <VideoClip src={clips[1]} playbackRate={0.8} />
          <AnimatedText text="The ocean stirs the heart, inspires the imagination." animation="fade-up" />
        </Transition>
      </Sequence>
