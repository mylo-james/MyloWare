...
// Object names extracted from ideation
const OBJECTS = [
  'Ignite Puppy', 'Velvet Blossom Puppy', 'Dual Liquid Mercury Puppy', 'Ocean Wave Puppy',
  'Golden Radiance Puppy', 'Crystalline Precision Puppy', 'Symmetrical Cloud Puppy', 'Shadow Essence Puppy',
  'Cosmic Star Puppy', 'Ancient Stone Puppy', 'Electric Neon Puppy', 'Dreamy Watercolor Puppy'
];
