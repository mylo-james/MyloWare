...
// Object names extracted from ideation (12 total, in zodiac order)
const OBJECTS = [
  'Blazing Lava Puppy', 'Velvet Pebble Puppy', 'Whispering Cloud Puppy', 'Fluid Water Puppy',
  'Golden Sun Puppy', 'Crystalline Puppy', 'Symmetrical Glass Puppy', 'Shadow Puppeteer',
  'Cosmic Star Puppy', 'Ancient Stone Puppy', 'Electric Neon Puppy', 'Dreamy Ocean Bubble Puppy'
];
