"""Deterministic KIE.ai fake client for testing."""
...
__all__ = ["KIEFakeClient"]


@dataclass
class KIEFakeClient:
    """Fake KIE client that returns deterministic responses."""
    ...
    def submit_job(
        ...
        *,
        ...
        job_id = f"fake-kie-{len(self.submitted_jobs)}"
        job = {
            "prompt": prompt,
            "run_id": run_id,
    ...
    def simulate_callback(self, job_id: str) -> Dict[str, Any]:
        ...
        return {
            "taskId": job_id,
            "status": "completed",
            "videoUrl": f"https://fake.kie.ai/{job_id}.mp4",
