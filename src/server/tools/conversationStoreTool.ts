...
export function registerConversationStoreTool(
  ...
  const definition = {
    ...
    description: [
      ...
      '',
      '## When to Use conversation_store',
      'Store conversation turns:',
      '- After user input (role: "user")',
      '- After agent output (role: "assistant")',
      '- Tool results (role: "tool")',
      '- System events (role: "system")',
      '',
      'ALWAYS include:',
      '- sessionId: Conversation identifier',
      '- content: Turn content (max 8000 chars)',
      '- metadata: Context about the turn',
      '',
      '## Automatic Behaviors',
      '- Generates embeddings for semantic search',
      '- Indexes for conversation_remember retrieval',
      '- Links to session timeline',
      '- Timestamps automatically',
      '',
      '## Best Practices',
      "Store rich metadata:",
      '- persona/project IDs if relevant',
      '- workflow name',
      '- quality indicators (validation status, scores)',
