  ...
  server.registerTool(
    toolName,
    {
      ...
      description: [
        ...
        '',
        '## When to Use video_query',
        'Use for:',
        '- Validating idea uniqueness before creation',
        '- Checking if idea exists globally (across all projects)',
        '- Finding similar existing ideas (with fuzzyMatch)',
        '',
        'Do NOT use for:',
        '- Semantic search (use prompt_search instead)',
        '- Finding patterns or themes (use prompt_search with expandGraph)',
        '- Session-scoped retrieval (use conversation_remember)',
        '',
        '## Usage',
