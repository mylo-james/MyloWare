  ...
  server.registerTool(
    toolName,
    {
      ...
      description: [
        ...
        '',
        '## When to Use prompt_search',
        '- DEFAULT CHOICE for most queries',
        '- Known filters: Apply persona/project metadata',
        '- Exploratory: Use hybrid mode + graph expansion',
        '- Exact specs: Use keyword mode',
        '- Recent focus: Set temporalBoost=true',
        '',
        '## Parameter Decision Tree',
        'searchMode:',
        '  - keyword: Exact terms, technical specs (e.g., "workflow definition")',
        '  - hybrid: Most queries - balanced semantic + lexical (DEFAULT)',
        '  - vector: Pure concept matching when terms unknown',
        '',
        'expandGraph:',
        '  - false: Direct matches only (faster, more precise)',
        '  - true: Include related concepts via memory links (creative, broader)',
        '',
        'graphMaxHops (when expandGraph=true):',
        '  - 1: Direct connections',
        '  - 2: Pattern discovery (RECOMMENDED for creative tasks)',
        '  - 3+: Deep exploration (rarely needed)',
        '',
        'temporalBoost:',
        '  - true: Prioritize recent updates (guidelines, recent patterns)',
        '  - false: All-time relevance (evergreen content)',
        '',
        '## Common Patterns',
        '1. Exact lookup: {searchMode: "keyword", project: "aismr"}',
        '2. Pattern discovery: {searchMode: "hybrid", expandGraph: true, graphMaxHops: 2}',
        '3. Recent updates: {searchMode: "hybrid", temporalBoost: true}',
        '4. Creative exploration: {searchMode: "vector", expandGraph: true, graphMaxHops: 2}',
      ].join('\n'),
