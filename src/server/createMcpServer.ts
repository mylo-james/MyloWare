import type { McpServer as McpServerType } from '@modelcontextprotocol/sdk/server/mcp.js' with {
...
export async function createMcpServer(): Promise<McpServerType> {
  const { McpServer } = (await import('@modelcontextprotocol/sdk/server/mcp.js')) as unknown as typeof import('@modelcontextprotocol/sdk/dist/cjs/server/mcp.js');
