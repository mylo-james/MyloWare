...
from safety.shields import SafetyResult, check_agent_input, check_agent_output
...
def _store_result(state: Dict[str, Any], cache_key: str, content_hash: str, result: SafetyResult):
