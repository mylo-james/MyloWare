...
const OBJECTS = [
  'Fiery Lava Puppy', 'Velvet Earth Puppy', 'Shifting Mirror Puppy', 'Ocean Wave Puppy',
  'Gold Leaf Puppy', 'Crystalline Puppy', 'Symmetrical Cloud Puppy', 'Shadowy Mist Puppy',
  'Cosmic Star Puppy', 'Stone Mountain Puppy', 'Electric Neon Puppy', 'Iridescent Watercolor Puppy'
];
