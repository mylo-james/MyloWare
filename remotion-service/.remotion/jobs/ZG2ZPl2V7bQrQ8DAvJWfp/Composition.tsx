...
// Object names based on creative direction
const OBJECTS = [
  'Fiery Lava Puppy', 'Velvet Moss Puppy', 'Cloud Whisper Puppies', 'Gentle Water Puppies',
  'Radiant Golden Puppy', 'Crystalline Glass Puppy', 'Symmetrical Flower Puppy', 'Shadowy Mist Puppy',
  'Cosmic Stardust Puppy', 'Stone Mountain Puppy', 'Electric Neon Puppy', 'Iridescent Dream Puppy'
];
