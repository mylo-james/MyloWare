...
// Object names extracted from ideation - REPLACE THESE
const OBJECTS = [
  'Crystal Puppy', 'Moss Puppy', 'Mirror Puppy', 'Bubble Puppy',
  'Golden Puppy', 'Glass Puppy', 'Silk Puppy', 'Shadow Puppy',
  'Cosmic Puppy', 'Stone Puppy', 'Electric Puppy', 'Cloud Puppy'
];
