...
const objects = ["Flame-Cooked Croissant","Velvet Croissant Garden","Dancing Mirror Croissants","Liquid Chocolate Croissant","Golden SunFlake Croissant","Crystalline Flake Croissant","Symmetrical Croissant Sculpture","Shadow-Cloaked Croissant","Cosmic Croissant Nebula","Ancient Stone Croissant","Electric Fusion Croissant","Dreamy Essence Croissant"];
