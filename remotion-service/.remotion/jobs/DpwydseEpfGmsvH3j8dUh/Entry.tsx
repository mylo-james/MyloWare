...
const objects = ["Blazing Lava Puppy","Loyal Earth Guardian","Chatty Breeze Twins","Nurturing Ocean Crab","Fiery Sun King","Meticulous Earth Fairy","Charming Scales","Intense River Scorpion","Adventurous Fire Archer","Ambitious Sea Goat","Innovative Water Bearer","Dreamy Ocean Fish"];
