...
const OBJECTS = [
  'Lava Puppy', 'Velvet Sand Puppy', 'Cloud Puppy', 'Waterflow Puppy',
  'Golden Flame Puppy', 'Crystalline Puppy', 'Mirror Glass Puppy', 'Shadow Puppy',
  'Cosmic Stardust Puppy', 'Stone Marble Puppy', 'Electric Neon Puppy', 'Dreamy Mist Puppy'
];
