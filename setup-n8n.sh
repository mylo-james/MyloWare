...
echo "   - Save"
echo ""
echo "8. Import the persona workflows (Casey, Iggy, Riley, Veo, Alex, Quinn):"
echo "   - Go to: Workflows > Import from File"
echo "   - Import each JSON from the ./workflows directory (casey → quinn)"
echo "   - After each import, update the credential references to use the ones you just created"
echo ""
echo "9. Test MCP connection inside one of the AI Agent nodes (they all share the same MCP client):"
