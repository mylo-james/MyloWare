...
@patch("workflows.hitl.log_hitl_event")
@patch("workflows.hitl.log_audit_event")
...
def test_approve_gate_publish(mock_audit, mock_telemetry):
    ...
    mock_repo.add_artifact.assert_called_once_with(run_id, "publish_override", "new publish content")
...
@patch("workflows.hitl.log_audit_event")
@patch("workflows.helpers.notify_telegram")
