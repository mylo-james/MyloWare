...
*Internal documents for project direction and technical exploration.*

| Document | Purpose |
|----------|---------|
| [Roadmap](ROADMAP.md) | Project phases, priorities, and future vision |
| [LangGraph Research](research/llama-stack-plus-langgraph.md) | Technical analysis of LangGraph integration |
