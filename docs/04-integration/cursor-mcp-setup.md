...
9. **session_get_context** – Hydrate or create a chat session
10. **session_update_context** – Persist session working memory
...
- Full docs: See [MCP Integration](mcp-integration.md)
