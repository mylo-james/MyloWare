...
We will use **LangGraph** for workflow orchestration only, while keeping Llama Stack for all AI operations (agents, inference, RAG, safety). Vector/hybrid search remains in **Milvus**; Postgres is used only for workflow SQL needs (runs, artifacts, checkpoints, DLQ).
...
- [Why Llama Stack](explanation/why-llama-stack.md) - v1 → v2 evolution
- [LangGraph Documentation](https://langchain-ai.github.io/langgraph/)
- ADR 0001: Llama Stack Foundation
