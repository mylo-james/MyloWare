...
```python
# src/tools/render/provider.py
from typing import Protocol

class RenderProvider(Protocol):
    async def render(self, composition: str, props: dict, webhook_url: str | None = None) -> RenderJob: ...
    async def get_status(self, job_id: str) -> RenderJob: ...

# src/tools/render/local.py
class LocalRemotionProvider:
    ...
    async def render(self, composition: str, props: dict, webhook_url: str | None = None) -> RenderJob:
        async with httpx.AsyncClient() as client:
            ...
            return RenderJob(id=resp.json()["job_id"], status="pending")
```
